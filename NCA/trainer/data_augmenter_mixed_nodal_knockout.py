...
"""
    Handles nodal knockout experiments. Need to take care of duplicate channels from different colonies,
    as well as different nodal knockout configurations being different batches.

    B0: same as in data_augmenter_micropattern_vgg_colony.py
    B1: knockout at 0h - some channels are replaced, some are zeroed out.
    B2: same as in data_augmenter_micropattern_vgg_colony.py
