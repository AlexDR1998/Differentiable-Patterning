...
def index_to_pde_gray_scott_rda(index):
	indices = np.unravel_index(index,(12,2))
	params = {
		...
		"TIME_RESOLUTION":[4,8,12,16,24,32][-1],
		"CHANNELS":32,
		"TRAJECTORY_FULL":[False,True][indices[1]],
		"TRAJECTORY_TYPE":["end","full"][indices[1]],	
		"TRAJECTORY_LENGTH":[1,2,3,4,6,8][-1],
		"LOSS_TIME_SAMPLING":1
	}
	return params
