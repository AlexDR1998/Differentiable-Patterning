...
def index_to_pde_gray_scott_rda(index):
	indices = np.unravel_index(index,(6,8))
	params = {
		...
		"TEXT_LABEL":["_euclidean","_spectral_weighted"][0]+["_nadam","_nadamw"][0]+["","_scale_by_param_block_norm"][1],
		...
		"TERMS":[["reaction_pure","diffusion_linear"],
				 ...
				 ["reaction_pure","advection","diffusion"]][0],
		...
		"TIME_RESOLUTION":[4,6,8,10,12,16][indices[0]],
		"CHANNELS":32,
		"MODEL_NUMBER":indices[1],
		"TRAJECTORY_FULL":[False,True][1],
		"TRAJECTORY_TYPE":["end","full"][1],	
		"TRAJECTORY_LENGTH":[1,2,2,3,3,4][indices[0]],
		"LOSS_TIME_SAMPLING":1
	}
	return params
