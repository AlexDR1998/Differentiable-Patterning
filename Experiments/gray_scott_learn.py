...
MODEL_FILENAME = "pde_hyperparameters_reacdiff/"+PARAMS["PDE_STR"]+"_tl_"+str(TRAJECTORY_LENGTH)+"_"+PARAMS["TRAJECTORY_TYPE"]+"_res_"+str(PARAMS["TIME_RESOLUTION"])+"_ch_"+str(CHANNELS)+"_ord_"+str(PARAMS["ORDER"])+"_l_"+str(PARAMS["N_LAYERS"])+"_"+"_".join(PARAMS["TERMS"])+PARAMS["TEXT_LABEL"]
